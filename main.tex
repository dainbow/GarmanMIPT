...
\begin{definition}
	В $C$ и $L_p$ плотные системы функций называются замкнутыми.
\end{definition}

\begin{corollary}
	$\{1,\,x,\,x^2,\,\cdots\}$ -- полна в $L_p[a,\,b],\, 1 \leq p < +\infty$, полная в $C[a,\,b]$.
\end{corollary}

\begin{corollary}
	$\{1,\,\cos(x),\,\sin(x),\,\cos(2x),\,\sin(2x),\,\cdots\}$ -- полная в $C_{2\pi}$
\end{corollary}
